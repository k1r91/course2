...
class Ui_TerminalMainWindow(object):
    def setupUi(self, TerminalMainWindow):
        ...
        self.widget.setGeometry(QtCore.QRect(90, 90, 969, 49))
        ...
        self.horizontal_display_top_layout = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget)
        self.horizontal_display_top_layout.setContentsMargins(0, 0, 0, 0)
        self.horizontal_display_top_layout.setObjectName("horizontal_display_top_layout")
