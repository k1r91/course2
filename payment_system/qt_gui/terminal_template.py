...
class Ui_TerminalMainWindow(object):
    def setupUi(self, TerminalMainWindow):
        ...
        self.widget = QtWidgets.QWidget(self.display_widget)
        self.widget.setGeometry(QtCore.QRect(110, 60, 971, 51))
        self.widget.setStyleSheet("border-image: none;")
        self.widget.setObjectName("widget")
        self.gridLayoutWidget_2 = QtWidgets.QWidget(self.widget)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(0, 0, 971, 51))
        self.gridLayoutWidget_2.setObjectName("gridLayoutWidget_2")
        self.grid_top = QtWidgets.QGridLayout(self.gridLayoutWidget_2)
        self.grid_top.setContentsMargins(0, 0, 0, 0)
        self.grid_top.setObjectName("grid_top")
        self.widget_2 = QtWidgets.QWidget(self.display_widget)
        self.widget_2.setGeometry(QtCore.QRect(80, 120, 1021, 401))
        self.widget_2.setStyleSheet("border-image: none;")
        self.widget_2.setObjectName("widget_2")
        self.gridLayoutWidget_3 = QtWidgets.QWidget(self.widget_2)
        self.gridLayoutWidget_3.setGeometry(QtCore.QRect(0, 0, 1021, 401))
