...
class Ui_TerminalMainWindow(object):
    def setupUi(self, TerminalMainWindow):
        ...
        TerminalMainWindow.resize(1285, 896)
...
"border-image: none;")
        ...
        self.pushButton_settings = QtWidgets.QPushButton(self.display_widget)
        self.pushButton_settings.setGeometry(QtCore.QRect(570, 490, 71, 41))
        ...
        self.pushButton_settings.setStyleSheet("border-image: none;\n"
"background-color: transparent;")
        self.pushButton_settings.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/terminal/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushStrongBox.setEnabled(False)
        self.pushStrongBox.setMinimumSize(QtCore.QSize(0, 250))
        self.pushStrongBox.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("img/terminal/strongbox.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushStrongBox.setIcon(icon1)
        self.pushStrongBox.setIconSize(QtCore.QSize(200, 200))
        ...
        self.pushCheckPrinter.setEnabled(False)
        self.pushCheckPrinter.setMinimumSize(QtCore.QSize(0, 250))
        self.pushCheckPrinter.setText("")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("img/terminal/check_printer.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushCheckPrinter.setIcon(icon2)
        self.pushCheckPrinter.setIconSize(QtCore.QSize(200, 200))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("img/terminal/10rubles.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.progressBar_bill_acceptor.setEnabled(False)
        self.progressBar_bill_acceptor.setGeometry(QtCore.QRect(0, 212, 181, 31))
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("img/terminal/50rubles.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("img/terminal/200rubles.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_200.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("img/terminal/100rubles.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("img/terminal/1000rubles.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_1000.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("img/terminal/500rubles.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_500.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("img/terminal/5000rubles.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_5000.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("img/terminal/2000rubles.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_2000.setIcon(icon10)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("img/terminal/bill_acceptor.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_bill_acceptor_icon.setIcon(icon11)
        ...
        self.label_error_bill_acceptor = QtWidgets.QLabel(self.widget_bill_acceptor)
        self.label_error_bill_acceptor.setGeometry(QtCore.QRect(210, 210, 181, 31))
        self.label_error_bill_acceptor.setStyleSheet("color: red;")
        self.label_error_bill_acceptor.setText("")
        self.label_error_bill_acceptor.setAlignment(QtCore.Qt.AlignCenter)
        self.label_error_bill_acceptor.setObjectName("label_error_bill_acceptor")
